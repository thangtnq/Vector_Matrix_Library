...
// TESTS:
//---------------------------------------------------------------------------
#if Matrix_mult_matrix_Test_Enable
TEST(Matrix_mult_matrix, matix_tests, Matrix_mult_matrix_Test_Enable)
{
...
#if Matrix_multEqual_matrix_Test_Enable
TEST(Matrix_multEqual_matrix, matix_tests, Matrix_multEqual_matrix_Test_Enable)
{
	Vect v0(1.0f, 2.0f, 3.0f, 4.0f);
	Vect v1(5.0f, 6.0f, 7.0f, 8.0f);
	Vect v2(9.0f, 10.0f, 11.0f, 12.0f);
