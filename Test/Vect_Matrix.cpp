...
#if Vect_mult_matrix_Enable
TEST(Vect_mult_matrix, vector_tests, Vect_mult_matrix_Enable)
{
...
#if Vect_multEqual_matrix_Enable
TEST(Vect_multEqual_matrix, vector_tests, Vect_multEqual_matrix_Enable)
{
	Vect vA(2.0f, 3.0f, 4.0f, -2.0f);
